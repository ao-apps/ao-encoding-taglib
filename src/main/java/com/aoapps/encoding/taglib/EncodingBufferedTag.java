 ...
 * Copyright (C) 2009, 2010, 2011, 2012, 2013, 2016, 2017, 2019, 2020, 2021, 2022, 2024, 2025, 2026  AO Industries, Inc.
...
public abstract class EncodingBufferedTag extends SimpleTagSupport {
  ...
  /**
   * @see  EncodingBufferedTag#newBufferWriter(com.aoapps.tempfiles.TempFileContext, long)
   * @see  TempFileContextEE#get(jakarta.servlet.ServletRequest)
   */
  ...
  /**
   * @see  EncodingBufferedTag#newBufferWriter(jakarta.servlet.ServletRequest, long)
   * @see  AutoTempFileWriter#DEFAULT_TEMP_FILE_THRESHOLD
   */
